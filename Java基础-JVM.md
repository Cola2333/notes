...
![image-20200527141259790](Java基础-JVM.assets/image-20200527141259790.png)

## JVM体系

线程私有：本地方法栈 程序计数器 操作方法栈

![image-20200527152918448](Java基础-JVM.assets/image-20200527152918448.png)
...
![image-20200528203639597](Java基础-JVM.assets/image-20200528203639597.png)
...
![image-20200529091940784](Java基础-JVM.assets/image-20200529091940784.png)

GC主要发生在伊甸园区和养老区

JDK8以后 永久存储区改名为元空间 **元空间在逻辑上存在 物理上不存在**

![image-20200529100050294](Java基础-JVM.assets/image-20200529100050294.png)
...
2. 根据打印出来的信息可以发现 新生代+老年代的内存就等于总内存了 所以说元空间在物理上是不存在的
   ...
   ![image-20200529101413832](Java基础-JVM.assets/image-20200529101413832.png)
...
![image-20200529150735090](Java基础-JVM.assets/image-20200529150735090.png)
